<template>
    <div class="wrapper">
        ...
        <scroller class="box" scroll-direction="horizontal" flex-direction="row" show-scrollbar=false>
            <div class="i-good" v-for="(i,idx) in goods" :key="idx">
                ...
                <div style="flex-direction:row;height:60px;">
                 <image class="gd-img" resize="cover" :src="i.img1" />
                <image class="gd-img" resize="cover" :src="i.img2" />

                <image class="gd-img" resize="cover" :src="i.img3" />
                </div>
              
                <div class="gd-price"> 
                <image style="height:15px;width:15px;" resize="cover" :src="position_img_base64" />

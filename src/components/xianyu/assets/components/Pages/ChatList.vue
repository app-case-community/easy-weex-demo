...
<div class="foot">
    <div class="inputbox">
        <image style="width: 30px;height: 30px;" src="https://coding.net/u/herozhou/p/weexassets/git/raw/master/images/%25E5%25BD%2595%25E9%259F%25B3.png"  class="speaks" />
        <input id="msg" @keypress.enter="sendMsg" type="text" placeholder="想对Ta说点什么" class="input"  v-model="content" />
        <image style="width: 30px;height: 30px;" src="https://coding.net/u/herozhou/p/weexassets/git/raw/master/images/%25E7%25AC%2591%25E8%2584%25B8.png" class="emoj" v-on:click="showBox=showBox==1?0:1" />
